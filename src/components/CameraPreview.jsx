...
function CameraPreview({ onTranscription }) {
  ...
  return (
    <div className="space-y-4 border-2 border-zinc-300 rounded-lg">
      <div className="relative">
        <video
          ref={videoRef}
          autoPlay
          playsInline
          className="w-[640px] h-[480px] bg-muted rounded-lg overflow-hidden m-5 "
        />
      ...
      {isStreaming && (
        <div className="w-[640px] h-2 rounded-full bg-green-100 m-5">
          <div
